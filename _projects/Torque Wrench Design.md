...
![Dimensions (Side View)]({{ "/assets/images/torque_wrench_side_view.png" | relative_url }}){: .inline-image-l} <br>
...
![Boundary Conditions (Displacement and Force)]({{ "/assets/images/torque_wrench_boundary_conditions.png" | relative_url }}){: .inline-image-l} <br>
...
![Normal Stress]({{ "/assets/images/torque_wrench_normal_stress.png" | relative_url }}){: .inline-image-l} <br>
<p><em>Figure 5. Normal Stress (FEM)</em></p> <br>
![Normal Strain]({{ "/assets/images/torque_wrench_normal_strain.png" | relative_url }}){: .inline-image-l} <br>
...
![Max Principal Stress]({{ "/assets/images/torque_wrench_max_stress.png" | relative_url }}){: .inline-image-l} <br>
...
![Strain Gauge]({{ "/assets/images/torque_wrench_strain_gauge.png" | relative_url }}){: .inline-image-l} <br>
